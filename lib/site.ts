 ...
 */
export const RECHNER_ANZAHL = 11
 ...
 */
export const RECHNER_ANZAHL_WORT = 'elf'
...
export const areas: Record<AreaId, Area> = {
  ...
  tools: {
    ...
    label: 'Rechner',
    href: '/rechner',
    description: `${RECHNER_ANZAHL} Rechner für Zinsen, Kredite, Kosten, Steuern, Vermögen, Inflation, Rente, Rentenlücke, Haushaltsbudget, Depotaufteilung und Sparpläne an echten Kursen – jeweils mit offengelegter Methodik.`,
  },
  news: {
    id: 'news',
    label: 'News',
