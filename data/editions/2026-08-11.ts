 ...
 * Quellenlage laut Kopf der Datei: Quellenlage 2026-08-11 02:21 UTC
 */
export const edition: DailyEdition = {
  date: '2026-08-11',
  intro:
    'Der 11.8.2026 in Zahlen aus dem eigenen Bestand. Was sich bewegt hat, wie breit es getragen war und was die Zahlen nicht verraten.',
  top: [
    {
      headline: 'Leitindizes: Nasdaq 100 vorn, Nikkei 225 (Japan) hinten',
      summary: [
        'Zum letzten abgerufenen Schluss steht Nasdaq 100 bei +1,19 Prozent, Nikkei 225 (Japan) bei −0,12 Prozent.',
    ...
    {
      headline: '512 Titel im Plus, 501 im Minus',
      summary: [
        'Am 10.8.2026 lag der ungewichtete Schnitt über alle ausgewerteten Aktien bei +0,22 Prozent.',
        'Die Bewegung war zu 50,5 Prozent getragen – so groß ist der Anteil der Titel, die mit dem Gesamtschnitt liefen.',
      ],
      category: 'Märkte',
      whyItMatters:
    ...
    {
      headline: 'Von +17,84 Prozent bis −13,55 Prozent: die Spanne des Tages',
      summary: [
        'Über 1026 geführte Aktien führte Kingspan, am Ende stand Lasertec.',
  ...
  further: [
    ...
    {
      headline: 'Gold bei 4.485,90 Dollar, umgerechnet rund 3.882,22 Euro',
      summary: [
        'Der Euro notierte zuletzt bei 1,1555 Dollar (Stand 10.8.2026).',
