...
export const technischeAnalyseLektionen: Lektion[] = [
  ...
  },
  {
    ...
    inhalt: [
      ...
      { type: 'heading', level: 2, text: 'Wie man das Werkzeug ansetzt' },
      {
        type: 'paragraph',
        text: 'Bis hierher stand, **welcher** Wert zu welcher Welle gehört. Jetzt geht es um den Handgriff davor: Auf welche zwei – oder drei – Punkte im Chart das Werkzeug gesetzt wird. Das ist die Stelle, an der die meisten Fehler entstehen, und sie fällt nicht auf: Ein falsch angesetztes Werkzeug zeichnet genauso saubere Linien wie ein richtiges.',
      },
      {
        type: 'paragraph',
        text: 'Alle drei Rechenarten arbeiten nach demselben Muster. **Zwei Punkte spannen eine Strecke auf, und ein dritter bestimmt, wo diese Strecke angetragen wird.** Beim Rücklauf fallen der zweite und der dritte Punkt zusammen – deshalb braucht er nur zwei Anker. Bei der Projektion sind es drei getrennte, und genau daher der andere Name im Programm.',
      },
      {
        type: 'heading',
        level: 3,
        text: 'Der Rücklauf: zwei Anker, und die Reihenfolge zählt',
      },
      { type: 'figure', figure: 'ta-elliott-ansetzen-ruecklauf' },
      {
        type: 'paragraph',
        text: 'Das Werkzeug heißt in den meisten Programmen **Fibonacci Retracement**. Es bekommt den Startpunkt der Welle, die gemessen wird, und ihren Endpunkt – in dieser Reihenfolge. Die 100 Prozent liegen dann am Start, die 0 Prozent am Ende. Wer die Anker vertauscht, bekommt dieselben Linien mit vertauschten Beschriftungen: Was 61,8 Prozent heißen sollte, steht dann bei 38,2.',
      },
      {
        type: 'callout',
        variant: 'tip',
        title: 'Die Probe, ob es richtig herum sitzt',
        items: [
          'Bei einer Aufwärtswelle muss die 0-Prozent-Linie **oben** liegen, am Hoch. Der Rücklauf misst, wie viel von der Bewegung zurückgegeben wurde – null zurückgegeben heißt: noch am Hoch.',
          'Bei einer Abwärtswelle entsprechend am Tief. Die 100 Prozent liegen immer am Ausgangspunkt der Bewegung.',
          'Wenn eine Marke von 61,8 Prozent über dem Hoch liegt, sitzt das Werkzeug verkehrt herum.',
        ],
      },
      {
        type: 'heading',
        level: 3,
        text: 'Die Streckung: gemessen an der einen Stelle, angetragen an einer anderen',
      },
      { type: 'figure', figure: 'ta-elliott-ansetzen-streckung' },
      {
        type: 'paragraph',
        text: 'Hier trennen sich Messen und Antragen zum ersten Mal, und das ist der Punkt, an dem es schiefgeht. Gemessen wird **Welle 1** – vom Start bis zum Ende. Angetragen wird diese Strecke aber nicht dort, sondern **ab dem Tief der Welle 2**. Das Ziel für Welle 3 ist also nicht „1,618 mal Welle 1 über dem Hoch der Welle 1", sondern „1,618 mal Welle 1 über dem Tief der Welle 2".',
      },
      {
        type: 'paragraph',
        text: 'Der Unterschied ist kein Detail. Bei einer Welle 1 von 100 Punkten und einer Welle 2, die 61,8 Prozent zurückholt, liegen die beiden Rechnungen **62 Punkte** auseinander – bei einer Bewegung, die insgesamt 162 Punkte umfasst.',
      },
      {
        type: 'heading',
        level: 3,
        text: 'Die Projektion: drei Anker',
      },
      { type: 'figure', figure: 'ta-elliott-ansetzen-projektion' },
      {
        type: 'paragraph',
        text: 'Für Welle 5 wird nicht die vorige Welle gemessen, sondern die **ganze bisherige Bewegung**: vom Start der Welle 1 bis zum Ende der Welle 3. Diese Strecke wird ab dem Tief der Welle 4 angetragen. Das Werkzeug dafür heißt in den gängigen Programmen **Trend-Based Fib Extension** und nimmt drei Klicks statt zwei – der dritte ist der Startpunkt, nicht ein weiterer Messpunkt.',
      },
      {
        type: 'table',
        caption:
          'Die Anker je Welle. Punkt 1 und 2 spannen die Strecke auf, Punkt 3 bestimmt, wo sie beginnt.',
        head: ['Ziel für', 'Werkzeug', 'Punkt 1', 'Punkt 2', 'Punkt 3'],
        rows: [
          [
            'Welle 2',
            'Retracement',
          ...
          ['Welle B', 'Retracement', 'Start Welle A', 'Ende Welle A', 'entfällt'],
          [
            'Welle C',
            'Trend-Based Extension',
            'Start Welle A',
      ...
      },
      {
        type: 'heading',
        level: 3,
        text: 'Docht oder Kerzenkörper?',
      },
      {
        type: 'paragraph',
        text: 'Eine Frage, die jede Zählung berührt und auf die es keine richtige Antwort gibt. Ein Hoch besteht aus dem Höchstkurs des Tages und dem Schlusskurs, und zwischen beiden können mehrere Prozent liegen. Je nachdem, welchen man ansetzt, verschieben sich sämtliche Marken.',
      },
      {
        type: 'callout',
        variant: 'info',
        title: 'Was sich dazu vertreten lässt',
        items: [
          'Auf **Extrempunkte** ansetzen – also Docht auf Docht – ist die verbreitetere Wahl. Begründung: Der gehandelte Höchstkurs ist der Punkt, an dem die Bewegung tatsächlich endete.',
          'Auf **Schlusskurse** ansetzen glättet Ausreißer einzelner Kerzen. Begründung: Ein Docht von wenigen Minuten ist kein Marktergebnis.',
          'Entscheidend ist nicht, welche Wahl man trifft, sondern dass man **innerhalb einer Zählung dabei bleibt**. Anker mischen heißt Strecken vergleichen, die verschieden gemessen wurden.',
          'Wer beides einträgt, sieht die Spanne. Sie ist ein ehrlicher Teil der Unsicherheit und verschwindet nicht dadurch, dass man sich für eine Linie entscheidet.',
        ],
      },
      { type: 'heading', level: 2, text: 'Die Reihenfolge beim Auftragen' },
      {
        type: 'list',
        ordered: true,
        items: [
          '**Zählung zuerst, Werkzeug danach.** Die Punkte im Chart markieren: Start von Welle 1, Ende jeder folgenden Welle. Ohne diese Punkte gibt es nichts zu messen – und wer das Werkzeug zuerst anlegt und die Zählung danach danebenlegt, hat die Reihenfolge umgedreht.',
          '**Die Rechenart wählen**, die zur laufenden Welle gehört – Rücklauf, Streckung oder Projektion. Die Tabelle oben nennt für jede Welle die Anker.',
          '**Prüfen, ob die Skala stimmt.** Bei einem Chart mit logarithmischer Achse rechnen die meisten Werkzeuge trotzdem linear. Über kurze Abschnitte fällt das nicht auf, über Jahre verschiebt es jede Marke.',
          '**Alle üblichen Werte auftragen**, nicht nur den häufigsten. Der Bereich dazwischen ist die Erwartung; die einzelne Linie täuscht eine Genauigkeit vor, die es nicht gibt.',
          '**Die Ausschlussmarke daneben eintragen.** Sie ist der einzige Wert, der die Zählung tatsächlich beenden kann, und sie liegt außerhalb des Zielbereichs.',
          '**Nach jeder abgeschlossenen Welle neu messen.** Die Ziele der folgenden Welle hängen an der tatsächlichen Länge der vorigen, nicht an der erwarteten. Eine Welle 3, die nur das 1,4-fache erreicht hat, verschiebt alle Ziele für 4 und 5.',
        ],
      },
      {
        type: 'callout',
        variant: 'warning',
        title: 'Vier Ansetzfehler, die sauber aussehen',
        items: [
          'Die Streckung für Welle 3 ab dem **Hoch der Welle 1** antragen statt ab dem Tief der Welle 2. Der häufigste Fehler überhaupt, und er macht das Ziel systematisch zu hoch.',
          'Die Projektion für Welle 5 an **Welle 3 allein** messen statt an der Strecke von 1 bis 3. Ergibt ein zu kurzes Ziel.',
          'Innerhalb einer Zählung zwischen **Docht und Schlusskurs** wechseln. Die Marken sind dann untereinander nicht vergleichbar.',
          'Das Werkzeug **stehen lassen**, nachdem die Zählung angepasst wurde. Die Linien bleiben im Chart, sind aber an Punkte gebunden, die nicht mehr gelten.',
        ],
      },
      {
        type: 'quote',
