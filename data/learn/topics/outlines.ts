...
/* -------------------------------------------------------------------------
   ...
   Diese Themen schlossen Lücken, die beim Aufbau der Reihenfolge sichtbar
   wurden: Zwischen „Notgroschen anlegen“ und „Aktie kaufen“ fehlten das
   Haushaltsbudget, das Risikoverständnis und das Depot; zwischen
   Nachrichtenlage und Anlageklasse fehlten Inflation, Notenbanken und
   Wechselkurse. Der größere Teil davon ist inzwischen ausformuliert und in
   eigene Dateien gewandert; hier steht nur noch, was aussteht.
   ------------------------------------------------------------------------- */
