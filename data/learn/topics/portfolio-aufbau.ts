    ...
    beginner: {
      ...
      blocks: [
        ...
        },
        {
          type: 'heading',
          level: 2,
          text: 'Die Quote bleibt nicht, wo du sie hingelegt hast',
        },
        {
          type: 'paragraph',
          text: 'Das ist der Punkt, an dem viele überrascht werden: Eine einmal festgelegte Aufteilung verschiebt sich von allein. Läuft der Aktienteil mehrere Jahre gut, wächst sein Anteil am Gesamtdepot, ohne dass jemand etwas entschieden hätte – und danach schwankt das Depot stärker, als geplant war. Fallen die Aktien, passiert das Gegenteil.',
        },
        {
          type: 'paragraph',
          text: 'Für diese Stufe genügt zu wissen, **dass** es passiert, und einmal im Jahr nachzusehen. Wer noch einzahlt, korrigiert es nebenbei: Die nächsten Raten gehen in den Topf, der zu klein geworden ist. Wie man es systematisch macht – nach Kalender oder nach Bandbreite, und wie sich Steuer dabei vermeiden lässt –, steht in der Stufe „Fortgeschritten“.',
        },
        {
          type: 'heading',
          level: 2,
          text: 'Was in den zweiten Topf gehört',
        },
        {
          type: 'paragraph',
          text: 'Ein einziger weltweit anlegender Fonds ist keine Notlösung, sondern deckt bereits tausende Unternehmen in dutzenden Ländern ab. Für den Anfang ist er vollständig ausreichend – und die häufigste Verschlechterung besteht darin, ihn zu ergänzen, ohne sagen zu können, wofür.',
        },
        {
          type: 'callout',
          variant: 'warning',
          title: 'Die Gegenprobe vor jedem zweiten Baustein',
          items: [
            '**Lässt sich sein Zweck in einem Satz sagen?** „War gerade gut gelaufen“ ist keiner.',
            '**Enthält er etwas, das der erste nicht hat?** Ein Technologie-ETF neben einem Welt-ETF bringt vor allem dieselben Unternehmen ein zweites Mal.',
            '**Ist er groß genug, um etwas zu ändern?** Unter fünf Prozent bewegt eine Position am Gesamtergebnis nichts Messbares – kostet aber dauerhaft Aufmerksamkeit.',
            'Wer eine dieser Fragen nicht beantworten kann, hat kein Depot gebaut, sondern eines wachsen lassen.',
          ],
        },
        {
          type: 'heading',
