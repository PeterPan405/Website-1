  ...
  levels: {
    ...
    beginner: {
      ...
      blocks: [
        ...
        {
          type: 'paragraph',
          text: 'Welche Fondsart wofür gebaut ist – Aktien, Anleihen, Mischung, Geldmarkt, Immobilien – und wo dabei die Fallstricke liegen, behandelt die Stufe „Fortgeschritten“. Für den Anfang genügt: Die Verpackung sagt wenig, der Inhalt alles.',
        },
        {
          type: 'heading',
          level: 2,
          text: 'Warum der Durchschnitt hinter dem Markt liegen muss',
        },
        {
          type: 'paragraph',
          text: 'Ein aktiver Fonds verspricht, besser zu sein als der Markt. Ob und wie oft das gelingt, prüft die Stufe „Fortgeschritten“ an den Daten. Ein Teil der Antwort steht aber schon fest, bevor man eine einzige Statistik ansieht – und er ist reine Arithmetik.',
        },
        {
          type: 'paragraph',
          text: 'Alle Anleger zusammen halten den gesamten Markt. Ihre gemeinsame Rendite **ist** deshalb die Marktrendite, vor Kosten. Nach Kosten liegt der Durchschnitt zwangsläufig darunter, und zwar genau um die Kosten. Ein Fonds mit 1,5 Prozent Gebühren muss den Markt also erst um 1,5 Prozent schlagen, nur um gleichauf zu sein. Das ist keine Kritik an einzelnen Fondsmanagern – es gilt unabhängig davon, wie gut sie sind.',
        },
        {
          type: 'heading',
          level: 2,
        ...
        },
        {
          ...
          items: [
            ...
            'Der Durchschnitt aller Fonds liegt nach Kosten unter dem Markt – das ist Arithmetik, keine Wertung.',
