...
export const philosophySections: PhilosophySection[] = [
  ...
  },
  {
    ...
    paragraphs: [
      ...
      '**Keine Dringlichkeit.** Es gibt keine Countdown-Angebote, keine Warnungen vor angeblich letzten Chancen und keine Panikmache. Dringlichkeit ist ein Instrument des Vertriebs – wer nichts verkauft, braucht sie nicht.',
  ...
  },
  {
    ...
    paragraphs: [
      ...
      'Das ist keine Nebensache. Bei Finanzinhalten entscheidet die Finanzierung darüber, welche Antwort sich lohnt. Wo eine Provision an einem Abschluss hängt, stellt sich die Frage „brauche ich das überhaupt?“ strukturell seltener als die Frage „welches Produkt?“. Wo nichts an der Entscheidung hängt, kann die Antwort auch lauten: gar nichts tun.',
