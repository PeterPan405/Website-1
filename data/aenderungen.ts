...
export const AENDERUNGEN: Aenderung[] = [
  {
    datum: '2026-08-23',
    art: 'geaendert',
    titel: 'Die sechzehn kürzesten Akademie-Lektionen sind ausgebaut',
    text: 'Die Akademie hat 70 Lektionen, und sechzehn davon waren erkennbar knapper als der Rest. Sie sind jetzt rund doppelt so ausführlich; keine Lektion liegt mehr unter 2.500 Zeichen. Neu ist unter anderem, wie sich aus dem Kurs-Umsatz-Verhältnis und der erwarteten Marge das spätere KGV ausrechnen lässt, warum die Trefferquoten von Kerzenmustern in Büchern höher ausfallen als in der Praxis, warum Kupfer der zuverlässigste Frühindikator unter den Rohstoffen ist und wo auch er blind bleibt, der Unterschied zwischen Stimmungsumfragen und gemessenem Verhalten, warum eine invertierte Zinskurve überhaupt etwas bedeutet und weshalb die Vorlaufzeit für eine Anlageentscheidung zu unscharf ist, wo mentale Buchführung Geld kostet und wo dieselbe Neigung nützt, Rebalancing über die Zuflüsse als einzige kostenlose Variante, die vier Anker, die im Depot am häufigsten wirken, warum der historische Maximalrückgang eine Untergrenze und kein Grenzwert ist, dass der Bestätigungsfehler an drei Stellen wirkt statt an einer, warum der Rückschaufehler das Lernen nicht erschwert, sondern verhindert, weshalb Mitlaufen für den Einzelnen oft vernünftig ist, warum eine schwache Währung Exporteuren erst nach Quartalen hilft, wo frisch geschaffenes Geld hängen bleibt, statt die Preise zu treiben, und warum dieselbe Konjunkturzahl je nach Umfeld steigende oder fallende Kurse auslöst. Die Lesezeiten sind mitgezogen.',
    ziel: { text: 'Zur Akademie', href: '/akademie' },
  },
  {
    datum: '2026-08-23',
    art: 'geaendert',
    titel:
      'Alle Fortgeschritten-Stufen sind jetzt so ausführlich wie die Beginner-Stufen',
    text: 'Die Fortgeschritten-Stufen waren im Schnitt ein Viertel dünner als die Beginner-Stufen darunter. Das ist jetzt vorbei: Alle 34 sind nachgezogen, im Schnitt von 8.664 auf 11.173 Zeichen, und keine liegt mehr unter der Stufe darunter. Neu sind unter anderem die FIFO-Regel beim Teilverkauf (verkauft wird die älteste und meist am höchsten besteuerte Tranche), die Risiken, für die es keine Kennzahl gibt, warum ein Budget typischerweise im dritten Monat kippt, was die einzelnen Ordnungsarten wirklich zusichern – Preis oder Ausführung, nie beides – dass Coins in Deutschland als andere Wirtschaftsgüter gelten und nach einem Jahr steuerfrei sind, ein Bitcoin-ETP dagegen nicht, die Kaufnebenkosten als Verlust am ersten Tag, warum sich eine Blase vorher nicht datieren lässt, wie viel überhaupt aufs Tagesgeld gehört, der Unterschied zwischen einem ETF als Sondervermögen und einem ETC als Schuldverschreibung – ein Buchstabe, ein völlig anderer Schutz – warum Wissen über Verhaltensmuster allein nichts ändert, warum schnelleres Wirtschaftswachstum keine höhere Aktienrendite bedeutet, wozu es Derivate volkswirtschaftlich überhaupt gibt, wann eine Datenbank die bessere Blockchain ist, wie ein ETF seinen Index tatsächlich nachbildet, die drei Schichten der Altersvorsorge und warum ihre Bindung zugleich Schutz und Fessel ist, warum man mit einer Option bei richtiger Meinung verlieren kann, und was die SCHUFA wirklich speichert. Die Lesezeiten sind mitgezogen.',
    ziel: {
